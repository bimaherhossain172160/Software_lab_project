...
<body>
  <div class="container">
    ...
    <div class="row">
          ...
          <?php
     $res=mysqli_query($link,"select * from products where p_status='1' and (category_name='$value' or brand_name='$value' or product_name like '%$value%') ");
      ...
      <div class="col-md-4 product-grid">
        ...
        <h5 class="text-center">Price: TK:<?php echo $row["product_price"]; ?>(tk)</h5>
